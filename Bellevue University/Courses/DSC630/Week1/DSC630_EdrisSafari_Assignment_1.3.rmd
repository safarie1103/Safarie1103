...
```{r plot dataset,cho=FALSE,message=FALSE,warning=FALSE}
...
GGally::ggpairs(all_items_cpi[c("Jan","Feb")],use="complete.obs")
```


```{r correlation2,echo=FALSE,message=FALSE,warning=FALSE}
GGally::ggpairs(all_items_cpi[c("Jan","Feb","Mar","Oct","Nov","Dec")],use="complete.obs")
```
